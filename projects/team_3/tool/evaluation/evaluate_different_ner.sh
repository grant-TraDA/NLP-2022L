...
for model in ner-multi ner-multi-fast; do
  python -m tool.scripts.compute_metrics data/novels_titles/polish_titles.txt data/testing_sets/"$1"/ experiments/"$2"/flair__${model}/ experiments/"$2"/flair__${model}/"$3" --print_results
done
